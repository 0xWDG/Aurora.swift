...
extension Collection {
    ...
    @inlinable public subscript(try index: Index) -> Element? {
...
extension Collection where Element: DivisibleArithmetic {
    ...
    @inlinable public func average() -> Element {
        sum() / Element(count)
    }
}
...
extension Collection where Element == Int {
    ...
    @inlinable public func average<ReturnType: DivisibleArithmetic>() -> ReturnType {
